# =========================================================
# Arc — Vercel Proxy
# Reverse proxy to Streamlit Cloud
# =========================================================
...
STREAMLIT_URL = "https://arc-eight.streamlit.app"
...
def proxy(path):
    ...
    try:
        resp = requests.request(
            ...
            timeout=25  # Vercel limit is 30s, but we stay safe
        )
    ...
    # Handle redirects (follow them and return final content)
    if resp.status_code in (301, 302, 303, 307, 308):
        ...
        if location:
            ...
            try:
                final_resp = requests.get(location, headers=headers, cookies=request.cookies, timeout=25)
